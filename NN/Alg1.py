...
def load_sample(seed, noise_level=0.1):
    setup       = get_setup(seed=seed, noise_level=noise_level)
    setup_clean = get_setup(seed=seed, noise_level=0.0)
...
RA            = fcts['RA']
C             = fcts['C']
compute_delta = fcts['compute_delta']  
gamma         = fcts['gamma']
alpha_fn      = fcts['alpha']
alpha_bar_fn  = fcts['alpha_bar']

# ============================================================
# problem of shape tenssor solving
# ============================================================
...
# ============================================================
# 11. Les 3 méthodes de comparaison
#     Budget fixe T_COMPARE itérations pour toutes les méthodes
# ============================================================
...
if __name__ == "__main__":
    ...
    # Moyenne sur les images de test  (toutes les listes ont longueur T_COMPARE)
    ...
    # --- Combien d'itérations pour atteindre un seuil ? ---
    threshold = 10-2   # 50% du résidu final de l'algo de base
