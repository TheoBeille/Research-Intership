...
def tgv(x_final, initial_state, alpha1=0.1, alpha0=0.1, eps=1e-8):
    """
    TGV l
    """
    
    u, w1, w2, f = extract_variables(x_final, initial_state)
    
    
    # DATA TERM
    data_term = 0.5 * torch.sum((u - f)**2)
